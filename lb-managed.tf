# Load balancer with managed instance group and autoscaling

# forward traffic to the correct load balancer for HTTP load balancing 
...
# virtual machines that will serve traffic for load balancing
